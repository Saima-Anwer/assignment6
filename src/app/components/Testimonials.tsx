            ...
            <div className="w-full flex justify-between items-center">
              ...
              <div className="flex gap-4">
                <button className="w-12 h-12 p-3 rounded-full border border-black flex items-center justify-center">
                  <Image src="/team/arrowleft.svg" className="ml-2" alt="Previous" width={16} height={16} />
                </button>
                <button className="w-12 h-12 p-3 rounded-full border border-black flex items-center justify-center">
                  <Image src="/team/arrowright.svg" className="ml-2" alt="Next" width={16} height={16} />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex self-stretch h-[417.89px] flex-col justify-start items-start gap-12">
            ...
            <div className="self-stretch justify-between items-center inline-flex">
              ...
              <div className="justify-start items-start gap-[15px] flex">
                <button className="w-12 h-12 p-3 rounded-full border border-black flex items-center justify-center">
                  <Image src="/team/arrowleft.svg" className="" alt="Previous" width={16} height={16} />
                </button>
                <button className="w-12 h-12 p-3 rounded-full border border-black flex items-center justify-center">
                  <Image src="/team/arrowright.svg" className="" alt="Next"  width={16} height={16} />
                </button>
              </div>
            </div>
          </div>
